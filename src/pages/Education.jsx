    ...
    <>
      <Link to={`/`}>
        <div className="container-home absolute flex w-full justify-end h-[50px] ">
          <p className="home-click text-lg pr-16 mt-4">Home</p>
        </div>{" "}
      </Link>
      <div className="education-page flex flex-col justify-center items-center h-screen lg:border-black lg:border-[3px] lg:m-10 lg:rounded-3xl m-10">
        ...
        <div className="flex flex-col lg:flex-row lg:gap-16 my-6">
          <div className="full-stack  h-[250px] lg:h-[650px] flex flex-col items-center w-[350px]">
            ...
            <p className=" lg:h-[200px]">
              Learn about programming and create web application projects with{" "}
              <span className=" font-semibold">agile</span> teamwork as a
              position of full-stack developer. <br />
